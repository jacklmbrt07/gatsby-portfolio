    ...
    <>
      <FooterStyle>
        <ContainerLayout>
          <FooterBody>
            <div>
              <p className="text-primary quote">Front-End Engineer at <a href="https://www.zennioptical.com/" target="_blank" rel="noreferrer" title="Learn more about Zenni">Zenni Optical</a></p>
